...
insert into eshop.line_of_basket(count, product_id, basket_id, position_cost) values ( 3, 1, 1, 1.0);
insert into eshop.line_of_basket(count, product_id, basket_id, position_cost) values ( 2, 2, 2, 1.0);