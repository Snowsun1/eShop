...
insert into eshop.aorder(order_id, date_of_order, basket_id) values (1, '2021-10-01', 1);
insert into eshop.aorder(order_id, date_of_order, basket_id) values (2, '10-1-22', 2);